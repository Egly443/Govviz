import{j as e,u as a,v as n,w as t}from"./vendor.js";import{T as s,F as i}from"./index.js";const o=`# Agentic Open Data: getting public statistics to the point where the machine just works
...
`;function r(){return e.jsxs("div",{className:"relative min-h-screen bg-background text-foreground",children:[e.jsx(s,{}),e.jsxs("main",{className:"mx-auto max-w-3xl px-4 pb-20 pt-10 sm:px-6",children:[e.jsx("article",{className:"prose-blog",children:e.jsx(a,{remarkPlugins:[n],children:o})}),e.jsxs("div",{className:"mt-10 rounded-xl border border-border bg-card p-5 text-sm text-muted-foreground",children:["Built and maintained in the open. Prefer the machine-readable version? Grab the"," ",e.jsx("a",{href:"/Govviz/blog.md",className:"text-primary hover:underline",children:"raw Markdown"})," ","(also served as a static, no-JavaScript page). If this is useful, you can"," ",e.jsx("a",{href:"https://github.com/Egly443/Govviz#support-this-work",target:"_blank",rel:"noopener noreferrer",className:"text-primary hover:underline",children:"support the work"})," ","or read the source on"," ",e.jsx("a",{href:"https://github.com/Egly443/Govviz/blob/main/docs/blog-open-data-for-ai.md",target:"_blank",rel:"noopener noreferrer",className:"text-primary hover:underline",children:"GitHub"}),"."]}),e.jsx(i,{})]})]})}const d=t("/blog")({component:r});export{d as Route};
